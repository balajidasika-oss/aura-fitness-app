...
export const PWAInstallPrompt: React.FC<PWAInstallPromptProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0F0F0F]  animate-in fade-in duration-200">
      <div className="relative w-full max-w-sm overflow-hidden rounded-3xl bg-gradient-to-b from-zinc-900 via-zinc-900 to-zinc-950 border border-neutral-800 p-5 shadow-none space-y-4">
        {/* Glow Accent */}
        <div className="absolute top-0 right-0 w-36 h-36 bg-neutral-800 rounded-full blur-3xl pointer-events-none" />

        {/* Header with Close */}
        <div className="flex items-center justify-between relative z-10">
          <div className="flex items-center space-x-2">
            <div className="w-9 h-9 rounded-2xl bg-neutral-800 text-neutral-200 flex items-center justify-center shadow-lg shadow-emerald-500/20">
              <Smartphone className="w-5 h-5" />
            </div>
            <div>
              <h3 className="text-sm font-black text-white">Install Aura Phone App</h3>
              <p className="text-[10px] text-neutral-400 font-medium">Fast, offline & instant home screen launch</p>
            </div>
          </div>
        ...
        {/* App Preview Card */}
        <div className="p-3.5 rounded-2xl bg-[#141414] border border-neutral-800 flex items-center space-x-3.5">
          ...
          <div className="flex-1">
            <div className="flex items-center space-x-1.5">
              ...
              <span className="text-[9px] font-bold text-neutral-200 bg-neutral-800 px-1.5 py-0.2 rounded border border-neutral-700">
                PWA v1.0
              </span>
            </div>
        ...
        {isStandalone && (
          <div className="p-3 rounded-2xl bg-neutral-800 border border-neutral-700 text-neutral-200 text-xs flex items-center space-x-2">
        ...
        {installedSuccessfully && (
          <div className="p-3 rounded-2xl bg-neutral-800 border border-neutral-700 text-neutral-200 text-xs flex items-center space-x-2 animate-bounce">
        ...
        {isIOS && !isStandalone && (
          <div className="space-y-2.5 p-3.5 rounded-2xl bg-neutral-800 border border-neutral-700">
            <div className="text-[11px] font-black text-neutral-300 uppercase tracking-wider flex items-center space-x-1.5">
              <span>📱 How to Install on iPhone / iPad:</span>
            </div>
            <ol className="space-y-2 text-xs text-zinc-300">
              <li className="flex items-start space-x-2">
                <span className="w-5 h-5 rounded-full bg-neutral-800 text-neutral-300 text-[10px] font-black flex items-center justify-center flex-shrink-0 mt-0.5">1</span>
              ...
              <li className="flex items-start space-x-2">
                <span className="w-5 h-5 rounded-full bg-neutral-800 text-neutral-300 text-[10px] font-black flex items-center justify-center flex-shrink-0 mt-0.5">2</span>
                <span>Scroll down and tap <strong className="text-white">"Add to Home Screen"</strong> <PlusSquare className="w-3.5 h-3.5 inline mx-1 text-neutral-200" />.</span>
              </li>
              <li className="flex items-start space-x-2">
                <span className="w-5 h-5 rounded-full bg-neutral-800 text-neutral-300 text-[10px] font-black flex items-center justify-center flex-shrink-0 mt-0.5">3</span>
            ...
            <button
              ...
              className={`w-full py-3 rounded-2xl text-xs font-black flex items-center justify-center space-x-2 transition shadow-lg ${
                deferredPrompt
                  ...
                  : 'bg-[#141414] text-neutral-400 cursor-not-allowed'
              }`}
            >
        ...
        <button
          type="button"
          onClick={handleClose}
          className="w-full py-2 text-xs font-bold text-neutral-400 hover:text-zinc-200 transition text-center"
        >

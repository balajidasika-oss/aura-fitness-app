...
export const ProgressRing: React.FC<ProgressRingProps> = ({
  ...
  return (
    <div className="relative flex items-center justify-center" style={{ width: size, height: size }}>
      ...
      {isComplete && (
        <div className="absolute inset-0 rounded-full bg-[var(--surface)] blur-xl animate-pulse" />
      )}
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center select-none">
        {isComplete ? (
          <div className="flex flex-col items-center">
            <span className="text-xl font-bold tracking-tight text-gray-200">100%</span>
            <span className="text-[10px] font-bold tracking-tight uppercase tracking-wider text-gray-200">
              3/3 DONE
            </span>
          </div>
        ) : (
          <div className="flex flex-col items-center">
            <span className="text-2xl font-bold tracking-tight text-white tracking-tight">
              {Math.round(val)}%
            </span>

...
export const LegalCenterModal: React.FC<LegalCenterModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#F4F2EC]  animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden rounded-[32px] bg-gradient-to-b from-zinc-900 via-zinc-900 to-zinc-950 border border-[#E6E4DD] shadow-none">
        {/* Top Header */}
        <div className="p-4 border-b border-[#E6E4DD] flex items-center justify-between bg-white shadow-sm  relative z-10">
          <div className="flex items-center space-x-2.5">
            <div className="w-8 h-8 rounded-[32px] bg-[#EAF0EA] text-[#4A5C4F] flex items-center justify-center shadow-md">
              <Scale className="w-4 h-4" />
            </div>
            <div>
              <h3 className="text-sm font-bold tracking-tight text-[#2D332F]">Aura Legal & Compliance Center</h3>
              <p className="text-[10px] text-[#7A8277] font-medium">Terms, Health Waiver & Privacy Protection</p>
            </div>
          </div>
          ...
          <button
            ...
            className="p-1.5 rounded-[32px] bg-white shadow-sm text-[#7A8277] hover:text-[#2D332F] transition"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        {/* Tab Switcher */}
        <div className="grid grid-cols-3 p-2 gap-1.5 bg-white shadow-sm border-b border-[#E6E4DD] text-xs">
          <button
            type="button"
            onClick={() => {
              soundFx.playTapSound();
            ...
            className={`py-2 px-1 rounded-[32px] font-bold flex items-center justify-center space-x-1.5 transition ${
              activeTab === 'parq'
                ? 'bg-red-500/20 text-red-300 border border-red-500/40 shadow-sm'
                : 'text-[#7A8277] hover:text-zinc-200 hover:bg-white shadow-sm'
            }`}
          >
          ...
          <button
            ...
            className={`py-2 px-1 rounded-[32px] font-bold flex items-center justify-center space-x-1.5 transition ${
              activeTab === 'privacy'
                ? 'bg-[#EAF0EA] text-[#4A5C4F] border border-[#E6E4DD] shadow-sm'
                : 'text-[#7A8277] hover:text-zinc-200 hover:bg-white shadow-sm'
            }`}
          >
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4 text-xs text-zinc-300 leading-relaxed font-normal">
          ...
          {activeTab === 'parq' && (
            <div className="space-y-3.5 animate-in fade-in duration-150">
              <div className="p-3 rounded-[32px] bg-red-950/40 border border-red-500/40 text-red-200 flex items-start space-x-2.5">
                <AlertTriangle className="w-4 h-4 text-red-400 flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-xs font-bold tracking-tight text-[#2D332F]">Physical Activity Readiness & Medical Disclaimer</h4>
              ...
              <div className="space-y-2">
                <h5 className="text-xs font-bold text-[#2D332F] uppercase tracking-wider">1. Not Medical Advice</h5>
                <p>
              ...
              <div className="space-y-2">
                <h5 className="text-xs font-bold text-[#2D332F] uppercase tracking-wider">2. PAR-Q Health Screening Checklist</h5>
                <p>
                ...
                <ul className="list-disc pl-4 space-y-1 text-[#7A8277]">
              ...
              <div className="space-y-2">
                <h5 className="text-xs font-bold text-[#2D332F] uppercase tracking-wider">3. Assumption of Risk & Voluntary Release</h5>
                <p>
          ...
          {activeTab === 'privacy' && (
            <div className="space-y-3.5 animate-in fade-in duration-150">
              <div className="p-3 rounded-[32px] bg-[#EAF0EA] border border-[#E6E4DD] text-[#4A5C4F] flex items-start space-x-2.5">
                <Shield className="w-4 h-4 text-[#4A5C4F] flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-xs font-bold tracking-tight text-[#2D332F]">Privacy Policy & Biometric Protection (GDPR / CCPA)</h4>
                  <p className="text-[11px] text-[#4A5C4F]/90 mt-0.5">
              ...
              <div className="space-y-2">
                <h5 className="text-xs font-bold text-[#2D332F] uppercase tracking-wider">1. Data We Collect</h5>
                <ul className="list-disc pl-4 space-y-1 text-[#7A8277]">
              ...
              <div className="space-y-2">
                <h5 className="text-xs font-bold text-[#2D332F] uppercase tracking-wider">2. Device Sensor Permissions (Camera & Microphone)</h5>
                <p>
              ...
              <div className="space-y-2">
                <h5 className="text-xs font-bold text-[#2D332F] uppercase tracking-wider">3. GDPR Data Subject Rights</h5>
              ...
              <div className="space-y-2">
                <h5 className="text-xs font-bold text-[#2D332F] uppercase tracking-wider">4. Security Disclaimer & "As Is" Provision</h5>
                <p>
                  While we implement strict cryptographic measures (e.g., PBKDF2 hashing) to protect your account, this platform is provided "AS IS" and without warranties. You agree that the creators and operators of Aura Fitness OS are <strong className="text-[#2D332F] font-bold">strictly not liable</strong> for any unauthorized access, data loss, server interruptions, or account breaches. Do not store sensitive health records beyond general fitness tracking on this platform.
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'terms' && (
            <div className="space-y-3.5 animate-in fade-in duration-150">
              <div className="p-3 rounded-[32px] bg-[#EAF0EA] border border-[#E6E4DD] text-[#4A5C4F] flex items-start space-x-2.5">
                <FileText className="w-4 h-4 text-[#4A5C4F] flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="text-xs font-bold tracking-tight text-[#2D332F]">Terms of Platform Service</h4>
                  <p className="text-[11px] text-[#4A5C4F]/90 mt-0.5">
              ...
              <div className="space-y-2">
                <h5 className="text-xs font-bold text-[#2D332F] uppercase tracking-wider">1. Account Responsibility</h5>
                <p>
              ...
              <div className="space-y-2">
                <h5 className="text-xs font-bold text-[#2D332F] uppercase tracking-wider">2. Acceptable Use & Media Uploads</h5>
                <p>
              ...
              <div className="space-y-2">
                <h5 className="text-xs font-bold text-[#2D332F] uppercase tracking-wider">3. Coach-Athlete Communication</h5>
                <p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-red-200/90 bg-red-950/20 p-2.5 rounded-[32px] border border-red-900/50">
        ...
        <div className="p-4 border-t border-[#E6E4DD] bg-white shadow-sm flex items-center justify-between">
          <div className="flex items-center space-x-1.5 text-[11px] text-[#4A5C4F] font-bold">
          ...
          <button
            ...
            className="py-2 px-5 rounded-[32px] bg-[#EAF0EA] hover:bg-[#EAF0EA] text-slate-950 text-xs font-bold tracking-tight transition shadow-lg shadow-emerald-500/20 active:scale-95"
          >
            I Understand & Agree
          </button>
        </div>

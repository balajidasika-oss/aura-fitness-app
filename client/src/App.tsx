...
const MainAppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F4F2EC] text-[#2D332F] flex flex-col font-sans selection:bg-[#EAF0EA] selection:text-slate-950">
      {/* Top Header */}
      <Header
        onOpenPWAInstall={() => setShowPWAInstall(true)}
        onOpenLegal={() => setShowLegalModal(true)}
      ...
      <footer className="w-full py-8 mt-auto border-t border-[#E6E4DD] bg-[#F4F2EC] backdrop-blur-3xl relative z-10">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4 bg-white shadow-sm pr-6 pl-2 py-2 rounded-full border border-[#E6E4DD] shadow-none">
            <img src="https://github.com/balajidasika.png" alt="Balaji Dasika" className="w-12 h-12 rounded-full border-2 border-[#E6E4DD] shadow-lg shadow-emerald-500/20" />
            <div className="text-left">
              <p className="text-[#2D332F] text-sm font-bold tracking-tight tracking-wide uppercase">Balaji Dasika</p>
              <p className="text-[#4A5C4F]/80 text-[10px] font-bold tracking-widest uppercase">Lead Engineer • Aura OS</p>
            </div>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-3">
            ...
            <a href="https://github.com/balajidasika" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 rounded-full bg-white shadow-sm hover:bg-white shadow-sm text-[#2D332F] font-bold text-xs uppercase tracking-wider transition-all flex items-center gap-2 border border-[#E6E4DD]">

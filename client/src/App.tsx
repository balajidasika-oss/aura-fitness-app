...
const MainAppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white flex flex-col font-sans selection:bg-neutral-800 selection:text-slate-950">
      {/* Top Header */}
      <Header
        onOpenPWAInstall={() => setShowPWAInstall(true)}
        onOpenLegal={() => setShowLegalModal(true)}
      ...
      <footer className="w-full py-8 mt-auto border-t border-neutral-800 bg-[#0F0F0F] backdrop-blur-3xl relative z-10">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4 bg-[#141414] pr-6 pl-2 py-2 rounded-full border border-neutral-800 shadow-none">
            <img src="https://github.com/balajidasika.png" alt="Balaji Dasika" className="w-12 h-12 rounded-full border-2 border-neutral-700 shadow-lg shadow-emerald-500/20" />
            <div className="text-left">
              <p className="text-white text-sm font-black tracking-wide uppercase">Balaji Dasika</p>
              <p className="text-neutral-200/80 text-[10px] font-bold tracking-widest uppercase">Lead Engineer • Aura OS</p>
            </div>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-3">
            ...
            <a href="https://github.com/balajidasika" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 rounded-full bg-[#141414] hover:bg-[#1A1A1A] text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center gap-2 border border-neutral-800">

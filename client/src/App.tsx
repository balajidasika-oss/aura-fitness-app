...
const MainAppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFF] text-black flex flex-col font-sans selection:bg-[#F5F5F7] selection:text-slate-950">
      {/* Top Header */}
      <Header
        onOpenPWAInstall={() => setShowPWAInstall(true)}
        onOpenLegal={() => setShowLegalModal(true)}
      ...
      <footer className="w-full py-8 mt-auto border-t border-[#EAEAEE] bg-[#FFFFFF] backdrop-blur-3xl relative z-10">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4 bg-white border border-[#EAEAEE] shadow-sm pr-6 pl-2 py-2 rounded-full border border-[#EAEAEE] shadow-none">
            <img src="https://github.com/balajidasika.png" alt="Balaji Dasika" className="w-12 h-12 rounded-full border-2 border-[#EAEAEE] shadow-lg shadow-[#FF3B30]/20" />
            <div className="text-left">
              <p className="text-black text-sm font-bold tracking-tight tracking-wide uppercase">Balaji Dasika</p>
              <p className="text-[#1C1C1E]/80 text-[10px] font-bold tracking-widest uppercase">Lead Engineer • Aura OS</p>
            </div>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-3">
            ...
            <a href="https://github.com/balajidasika" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 rounded-full bg-white border border-[#EAEAEE] shadow-sm hover:bg-white border border-[#EAEAEE] shadow-sm text-black font-bold text-xs uppercase tracking-wider transition-all flex items-center gap-2 border border-[#EAEAEE]">

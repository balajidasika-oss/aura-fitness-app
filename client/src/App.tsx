...
const MainAppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent text-white flex flex-col font-sans selection:bg-[var(--surface)] selection:text-white">
      {/* Top Header */}
      <Header
        onOpenPWAInstall={() => setShowPWAInstall(true)}
        onOpenLegal={() => setShowLegalModal(true)}
      ...
      <footer className="w-full py-8 mt-auto border-t border-[var(--border)] bg-transparent backdrop-blur-3xl relative z-10">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4 bg-[var(--surface)] border border-[var(--border)] shadow-[0_4px_20px_rgba(0,0,0,0.2)] pr-6 pl-2 py-2 rounded-full border border-[var(--border)] shadow-none">
            <img src="https://github.com/balajidasika.png" alt="Balaji Dasika" className="w-12 h-12 rounded-full border-2 border-[var(--border)] shadow-lg shadow-[#FF3B30]/20" />
            <div className="text-left">
              <p className="text-white text-sm font-bold tracking-tight tracking-wide uppercase">Balaji Dasika</p>
              <p className="text-gray-200/80 text-[10px] font-bold tracking-widest uppercase">Lead Engineer • Aura OS</p>
            </div>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-3">
            ...
            <a href="https://github.com/balajidasika" target="_blank" rel="noopener noreferrer" className="px-5 py-2.5 rounded-full bg-[var(--surface)] border border-[var(--border)] shadow-[0_4px_20px_rgba(0,0,0,0.2)] hover:bg-[var(--surface)] border border-[var(--border)] shadow-[0_4px_20px_rgba(0,0,0,0.2)] text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center gap-2 border border-[var(--border)]">

...
export const GamificationDashboard: React.FC = () => {
  return (
    <div className="w-full bg-[#FFFFFF]  border border-[#EAEAEE] rounded-2xl p-6 md:p-8 mb-8 relative overflow-hidden">
      {/* Background Gradients */}
      <div className="absolute -top-20 -right-20 w-64 h-64 bg-[#F5F5F7] rounded-full blur-[80px] pointer-events-none" />
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-black uppercase tracking-tight flex items-center gap-3">
            <Trophy className="w-6 h-6 text-yellow-400" />
            Athlete Profile
          </h2>
          <p className="text-[#1C1C1E]/80 font-medium mt-1">Level 4 • Pro Contender</p>
        </div>
        
        <div className="flex items-center gap-4">
          <div className="bg-white border border-[#EAEAEE] shadow-sm border border-[#EAEAEE] rounded-2xl px-5 py-3 flex flex-col items-center justify-center">
            <span className="text-sm text-gray-400 font-semibold uppercase tracking-wider mb-1">Streak</span>
            <div className="flex items-center gap-2">
              <Flame className="w-5 h-5 text-orange-500 fill-orange-500" />
              <span className="text-xl font-bold tracking-tight text-black">5 Days</span>
            </div>
          </div>
          <div className="bg-white border border-[#EAEAEE] shadow-sm border border-[#EAEAEE] rounded-2xl px-5 py-3 flex flex-col items-center justify-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold tracking-tight text-black">12.4k lbs</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 relative z-10">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs font-bold text-[#1C1C1E] bg-[#F5F5F7] px-2 py-1 rounded-md">2 / 12 Unlocked</span>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {/* Unlocked Badge */}
          <div className="bg-gradient-to-br from-emerald-500/20 to-emerald-900/20 border border-[#EAEAEE] rounded-2xl p-4 flex flex-col items-center text-center shadow-none relative overflow-hidden group hover:scale-105 transition-all cursor-pointer">
            ...
            <h4 className="text-black font-bold text-sm">First Flow</h4>
            <p className="text-[#1C1C1E] text-xs font-medium mt-1">Completed Yoga</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-pink-500/20 to-pink-900/20 border border-pink-500/30 rounded-2xl p-4 flex flex-col items-center text-center shadow-none relative overflow-hidden group hover:scale-105 transition-all cursor-pointer">
            ...
            <h4 className="text-black font-bold text-sm">Rhythm King</h4>
            <p className="text-pink-400 text-xs font-medium mt-1">Completed Zumba</p>
          </div>
          
          {/* Locked Badge */}
          <div className="bg-white border border-[#EAEAEE] shadow-sm border border-[#EAEAEE] rounded-2xl p-4 flex flex-col items-center text-center opacity-50 grayscale cursor-not-allowed">

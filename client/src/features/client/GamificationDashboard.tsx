...
export const GamificationDashboard: React.FC = () => {
  return (
    <div className="w-full bg-black/40 backdrop-blur-xl border border-white/5 rounded-3xl p-6 md:p-8 mb-8 relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
        <div>
          ...
          <p className="text-emerald-400/80 font-medium mt-1">Level 4 • Pro Contender</p>
        </div>
      ...
      <div className="mt-8 relative z-10">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs font-bold text-emerald-400 bg-emerald-500/10 px-2 py-1 rounded-md">2 / 12 Unlocked</span>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {/* Unlocked Badge */}
          <div className="bg-gradient-to-br from-emerald-500/20 to-emerald-900/20 border border-emerald-500/30 rounded-2xl p-4 flex flex-col items-center text-center shadow-[0_0_20px_rgba(16,185,129,0.15)] relative overflow-hidden group hover:scale-105 transition-all cursor-pointer">
            ...
            <p className="text-emerald-400 text-xs font-medium mt-1">Completed Yoga</p>
          </div>
          
          {/* Unlocked Badge */}
          <div className="bg-gradient-to-br from-pink-500/20 to-pink-900/20 border border-pink-500/30 rounded-2xl p-4 flex flex-col items-center text-center shadow-[0_0_20px_rgba(236,72,153,0.15)] relative overflow-hidden group hover:scale-105 transition-all cursor-pointer">
          ...
          {/* Locked Badge */}
          <div className="bg-white/5 border border-white/5 rounded-2xl p-4 flex flex-col items-center text-center opacity-50 grayscale cursor-not-allowed">
